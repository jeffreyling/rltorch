...
env = rltorch.Atari_v0({rom="environments/ale/roms/space_invaders.bin"})
math.randomseed(os.time())
env=rltorch.MonitoredEnvironment(env,log,DISCOUNT_FACTOR)
sensor=rltorch.BatchVectorSensor_ForAtari(env.observation_space,40,30)
